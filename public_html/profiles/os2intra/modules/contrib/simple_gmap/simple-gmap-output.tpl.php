...
?>
<iframe width="<?php print $width; ?>" height="<?php print $height; ?>" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.google.com/maps/embed?origin=mfe&amp;pb=!1m4!2m1!1s<?php print $url_suffix; ?>!5e<?php print $new_map_type; ?>!6i<?php print $zoom; ?>!5m1!1s<?php print $langcode; ?>"></iframe>
<?php
}
