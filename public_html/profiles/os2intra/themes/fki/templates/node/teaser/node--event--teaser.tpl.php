        ...
        <div class="table-cell">
          ...
          <?php if (isset($author_full_name) and $updated_at_short): ?>
            ...
            <ul class="os2-node-teaser-info os2-entity-info">
              <li><span class="fa fa-calendar"></span> <?php print l($author_full_name, 'user/' . $node->uid); ?></li>
          ...
          <div class="dato h5">
            <?php print render($content['field_os2intra_date']); ?>
          </div>
            <?php if (isset($content['body'])): ?>
              ...
              <!-- End - body -->
            <?php endif; ?>
            <?php print render($content['field_os2intra_event_type']); ?>
