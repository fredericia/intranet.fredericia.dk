...
/* Additional function (not part of the original module) */
...
function push_notifications_menu() {
  ...
  items['user/logout'] = {
    ...
    pagechange: '_push_notifications_logout_pagechange',
...
function _push_notifications_logout_pagechange() {
  try {
    // Just before user logs out, delete the token.
    push_notifications_delete_device_token();
  ...
  catch (error) { console.log('_push_notifications_logout_pagechange - ' + error); }
}
