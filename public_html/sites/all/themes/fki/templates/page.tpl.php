    ...
    <footer class="footer">
      ...
      <div class="footer-upper-content">
        <div class="container">
          ...
          <?php if ($theme_settings['layout']['footer']['show_social_links']): ?>
            <div class="row">
              <div class="col-xs-12 footer-social-icon-container">
      ...
      <div class="footer-lower-content">
        <div class="container">
          <div class="row">
            <div class="col-xs-12 text-center">
              <p><?php print $theme_settings['contact_information']['business_owner_name']; ?> &copy; <?php print $theme_settings['layout']['copyright']; ?>. <?php print t('Alle rettigheder reserveres'); ?>. <a href="#"><?php print t('Betingelser for privatliv'); ?>.</a></p>
            </div>
          </div>
        </div>
      </div>
